...
<div id="section" class="clearfix">
	...
	<ul class="articleSearch clearfix">
		<?php if(is_array($var)): foreach($var as $key=>$v): ?><li class="article">
			<div class="a_wrap" _id="<?php echo ($v["id"]); ?>">
				<a target="_blank" href="<?php echo ($v["href"]); ?>">
					<div class="up_part">
						<div class="water"></div>
					</div>
					<div class="mid_part">
						<h4 title="<?php echo ($v["title"]); ?>" class="ellipsis"><?php echo ($v["title"]); ?></h4>
						<p style="height:85px;overflow:hidden;"><?php echo ($v["content"]); ?></p>
					</div>
				</a>
				<div class="down_part">
					<div class="love">
